...
def cast_lightning(*args, **kwargs):
    ...
    if target:
        results.append({'consumed': True, 'message': Message('A lightning bolt strikes the {0} with a loud thunder! '
...
def cast_fireball(*args, **kwargs):
    ...
    results.append({'consumed': True,
                    'message': Message('The fireball explodes, burning everything '
                                       'within {0} tiles!'.format(radius), libtcod.orange)})
